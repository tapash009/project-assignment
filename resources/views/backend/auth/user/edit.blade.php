...
@section('content')
{{ html()->modelForm($user, 'PATCH', route('admin.auth.user.update', $user->id))->class('form-horizontal')->id('edit_user_form')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('country_id', $countries, $user->user_address->country_id)
                            ->class('form-control')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('state_id', $states, $user->user_address->state_id)
                            ->class('form-control')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->text('city', $user->user_address->city)
                                ->class('form-control')
                                ->placeholder('City')
                                ->attribute('maxlength', 191)
                                ->required()
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->textarea('address', $user->user_address->address)
                                ->class('form-control')
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col text-right">
                    <button class="btn btn-success btn-sm pull-right" type="submit" id="edit_user_btn">Update</button>
                </div><!--row-->
            </div><!--row-->
        </div><!--card-footer-->
    </div><!--card-->
