...
class UserRepository extends BaseRepository
{
     ...
     * @param State $state
     */
    public function __construct(User $model, Country $country, State $state)
    {
        $this->model = $model;
    ...
    public function getCountries(){
        ...
        foreach ($countries as $country){
            $theArr[$country->id] = $country->name;
        }
        return $theArr;
    }
    ...
    public function getStates($country_id){
        $theArr = [];
        $states = $this->state->where('country_id', $country_id)->get();
        foreach ($states as $state){
            $theArr[$state->id] = $state->name;
        }
        return $theArr;
    }
}
